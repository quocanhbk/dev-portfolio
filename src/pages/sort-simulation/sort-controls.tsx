...
const SortControls = ({
  ...
  return (
    <div className="p-4 overflow-auto">
      <div className="w-80 bg-slate-900 p-6 flex flex-col h-full rounded-2xl shadow-lg">
        <h2 className="text-white text-xl font-bold mb-6 font-mono">Sort Simulation</h2>
